...
/*   Updated: 2025/01/14 21:02:13 by abaldo-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc == 2)
	{
		...
		handle_map(argv[1]);
		// 1.1 Chequear el formato, que todas la lineas sean iguales y 
		// que no haya cosas qeu no sean numeros, positivos o negatvios
		check_format(argv[1]);
